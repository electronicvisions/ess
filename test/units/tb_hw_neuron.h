#ifndef _TB_HW_NEURON_H_
#define _TB_HW_NEURON_H_	
 ...
 */ 
class tb_hw_neuron: public anncore_pulse_if, public sc_module {
	...
	public:
		...
		SC_HAS_PROCESS(tb_hw_neuron);
		/** Constructor
		 */
		tb_hw_neuron(sc_module_name name);
		virtual ~tb_hw_neuron();
};
#endif// _TB_HW_NEURON_H_	
